...
export const SPECIALIST_TEAM = [
    ...
    { 
        ...
        description: 'ผู้เชี่ยวชาญด้านอาหาร วิเคราะห์ตามหลักกรมอนามัย (สูตร 2:1:1) และลดหวานมันเค็ม',
        personality: 'ละเอียด, อ้างอิงหลักการ, เน้นโภชนาการ, ให้สูตรอาหารได้',
        topics: ['ลดน้ำหนัก', 'คุมน้ำตาล/เบาหวาน', 'สูตร 2:1:1', 'ลดหวานมันเค็ม', 'แพ้อาหาร']
    },
    { 
        id: 'trainer', 
        name: 'เทรนเนอร์', 
        ...
        description: 'โค้ชออกกำลังกาย แนะนำตามเกณฑ์ 150 นาที/สัปดาห์ และการเผาผลาญไขมัน',
    ...
    { 
        ...
        description: 'ที่ปรึกษาด้านจิตใจ ช่วยจัดการความเครียด และให้คำปรึกษาการเลิกบุหรี่/สุรา (5A Model)',
        personality: 'อบอุ่น, รับฟัง, นุ่มนวล, เน้นความเข้าใจอารมณ์',
        topics: ['เครียดจากการงาน', 'หมดไฟ (Burnout)', 'เลิกบุหรี่/สุรา', 'จัดการอารมณ์ลบ']
    },
    { 
        id: 'sleep_expert', 
    ...
    { 
        ...
        description: 'แพทย์ผู้ดูแลโรค NCDs ให้คำแนะนำเรื่องยาและการเตรียมตัวก่อนตรวจ',
        personality: 'เป็นทางการ, น่าเชื่อถือ, ห่วงใย, เน้นข้อมูลทางการแพทย์',
        topics: ['คุมความดันโลหิต', 'การใช้ยาต่อเนื่อง', 'เลิกบุหรี่/สุรา', 'เตรียมตัวตรวจเลือด']
    },
];
